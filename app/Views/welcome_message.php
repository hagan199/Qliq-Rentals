...
<!-- Mirrored from html.airui.cloud/versions/left-default-gray/dashboards-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 22:31:36 GMT -->
<head>
  <meta charset="UTF-8">
    ...
    <div class="air__menuLeft__container kit__customScroll">
      <ul class="air__menuLeft__list">
        ...
        <li class="air__menuLeft__item air__menuLeft__submenu">
          ...
          <ul class="air__menuLeft__list">
            <li class="air__menuLeft__item">
              <a href="https://html.airui.cloud/versions/no-layout/auth-login.html" class="air__menuLeft__link">
                <span>Login</span>
              </a>
            </li>
            <li class="air__menuLeft__item">
            ...
            <li class="air__menuLeft__item">
              <a href="https://html.airui.cloud/versions/no-layout/auth-register.html" class="air__menuLeft__link">
                <span>Register</span>
              </a>
            </li>
            <li class="air__menuLeft__item">
              <a href="https://html.airui.cloud/versions/no-layout/auth-lockscreen.html" class="air__menuLeft__link">
                <span>Lockscreen</span>
              </a>
            </li>

            <li class="air__menuLeft__item">
              <a href="https://html.airui.cloud/versions/no-layout/auth-404.html" class="air__menuLeft__link">
                <span>Page 404</span>
              </a>
            </li>
            <li class="air__menuLeft__item">
              <a href="https://html.airui.cloud/versions/no-layout/auth-500.html" class="air__menuLeft__link">
                <span>Page 500</span>
              </a>
            </li>
          </ul>
...
<a href="javascript: void(0);" style="bottom: calc(50% + 60px)"
  class="air__sidebar__toggleButton air__sidebar__actionToggleTheme" data-toggle="tooltip" data-placement="left"
  title="Switch Dark / Light Theme">
  <i class=" fe fe-moon air__sidebar__on"></i>
  <i class="fe fe-sun air__sidebar__off"></i>
</a>
<a href="javascript: void(0);" style="bottom: calc(50%)" class="air__sidebar__toggleButton color reset"
  data-toggle="tooltip" data-placement="left" title="Set Primary Color">
...
<a href="https://docs.sellpixels.com/" target="_blank" rel="noopener noreferrer" style="bottom: calc(50% - 60px)"
  class="air__sidebar__toggleButton" data-toggle="tooltip" data-placement="left" title="Documentation">
...
<div>
  ...
  <ul class="list-unstyled">
    <li class="kit__l1__item">
      <a href="#" class="kit__l1__itemLink">
        <div class="kit__l1__itemPic mr-3">
          <i class="kit__l1__itemIcon fe fe-file"></i>
        </div>
        <div>
  ...
  <ul class="list-unstyled">
    <li class="kit__l1__item">
      <a href="#" class="kit__l1__itemLink">
        <div class="kit__utils__avatar mr-3">
          <img src="../../components/kit/core/img/avatars/5.jpg" alt="Mary Stanform" />
        </div>
        <div>
    ...
    <li class="kit__l1__item">
      <a href="#" class="kit__l1__itemLink">
        <div class="kit__utils__avatar mr-3">
          <img src="../../components/kit/core/img/avatars/1.jpg" alt="Jamie Rockstar" />
        </div>
        <div>
  ...
  <p class="mb-0 mr-4 d-xl-block d-none">
    Status
    <span class="ml-1 badge bg-danger text-white font-size-12 text-uppercase air__topbar__status">Trialing</span>
  </p>
  <div class="dropdown mr-4 d-none d-sm-block">
    ...
    <div class="dropdown-menu dropdown-menu-right" role="menu">
      <a class="dropdown-item" href="javascript:void(0)"><span
          class="text-uppercase font-size-12 mr-1 align-text-bottom">EN</span> English</a>
      <a class="dropdown-item" href="javascript:void(0)"><span
          class="text-uppercase font-size-12 mr-1 align-text-bottom">RU</span> Русский</a>
      <a class="dropdown-item" href="javascript:void(0)"><span
          class="text-uppercase font-size-12 mr-1 align-text-bottom">CN</span> 简体中文</a>
    </div>
  </div>
...
<div class="kit__c2__chart height-200 ct-hidden-points"></div>

<script>
  /////////////////////////////////////////////////////////////////////////////////////////
  // "Chart Widget 2" module scripts
      ...
      <div class="col-xl-6 col-lg-12">
        <div class="card">
          <div class="card-body">
            <div class="text-dark font-size-18 font-weight-bold mb-1">Year Profit</div>
<div class="text-gray-6 mb-2">Revenue by location and date</div>
<div class="kit__c9__chartContainer d-flex flex-wrap align-items-center">
  <div class="mr-3 mt-3 mb-3 position-relative">
    <canvas class="kit__c9__chart" width="140" height="140"></canvas>
    <div class="kit__c9__chartTooltip text-gray-5 font-size-28" id="chart9-tooltip"></div>
  </div>
</div>
...
<script>
  ...
  ;(function($) {
    ...
    $(function() {
      /////////////////////////////////////////////////////////////////////////////////////////
      const chart9 = new Chart(document.getElementsByClassName('kit__c9__chart'), {
        type: 'doughnut',
        data: {
        ...
        options: {
          ...
          legendCallback: function(chart) {
            ...
            for (let i = 0; i < chart.data.labels.length; i++) {
              ...
              text.push(
                '<div class="d-flex align-items-center flex-nowrap mt-2 mb-2"><div class="kit__c9__tablet mr-3" style="background-color:' +
                  tabletBg +
                  '"></div>' +
                  label +
                  '</div>',
      ...
      $('.kit__c9__chartContainer').append(chart9Legend[0])
      /////////////////////////////////////////////////////////////////////////////////////////
    })
  })(jQuery)
</script>
        ...
        <div class="card">
          <div class="card-body">
            <div class="text-dark font-size-18 font-weight-bold mb-1">Year Profit</div>
<div class="text-gray-6 mb-2">Revenue by location and date</div>
<div class="kit__c5__chart height-200"></div>

<script>
  /////////////////////////////////////////////////////////////////////////////////////////
  // "Chart Widget 5" module scripts
          ...
          series: [
            {
              ...
              data: [5, 4, 3, 7, 5, 10, 3, 4, 8, 10, 6, 8, 6, 7],
            },
            {
              className: 'ct-series-m',
              data: [3, 2, 9, 5, 4, 6, 4, 6, 7, 8, 7, 4, 3, 9],
            },
          ],
        },
        {
...
<div class="text-gray-6 mb-2">Revenue by location and date</div>
<div class="kit__c10__chartContainer d-flex flex-wrap align-items-center">
  <div class="mr-3 mt-3 mb-3 position-relative">
    <canvas class="kit__c10__chart" width="140" height="140"></canvas>
    <div class="kit__c10__chartTooltip text-center" id="chart10-tooltip">
      <div class="kit__c10__tooltipLabel font-size-14 font-weight-bold text-dark"></div>
      <div class="kit__c10__tooltipValue font-size-14 text-dark"></div>
    </div>
  </div>
</div>
...
<script>
  ...
  ;(function($) {
    ...
    $(function() {
      /////////////////////////////////////////////////////////////////////////////////////////
      const chart10 = new Chart(document.getElementsByClassName('kit__c10__chart'), {
        type: 'doughnut',
        data: {
        ...
        options: {
          ...
          legendCallback: function(chart) {
            let text = []
            text.push('<div class="kit__c10__chartLegend flex-shrink-0">')
            for (let i = 0; i < chart.data.labels.length; i++) {
              const label = chart.data.labels[i]
              const tabletBg = chart.data.datasets[0].backgroundColor[i]
              text.push(
                '<div class="d-flex align-items-center flex-nowrap mt-2 mb-2"><div class="kit__c10__tablet mr-3" style="background-color:' +
                  tabletBg +
                  '"></div>' +
                  label +
                  '</div>',
          ...
          tooltips: {
            ...
            custom: function(tooltip) {
              ...
              if (tooltip.body) {
                ...
                tooltipEl.querySelector('.kit__c10__tooltipLabel').innerHTML = label
                tooltipEl.querySelector('.kit__c10__tooltipValue').innerHTML = value
              }
      ...
      $('.kit__c10__chartContainer').append(chart10Legend[0])
      /////////////////////////////////////////////////////////////////////////////////////////
    })
  })(jQuery)
</script>
...
<div class="kit__c1__chart ct-chart height-300"></div>

<script>
  /////////////////////////////////////////////////////////////////////////////////////////
  // "Chart Widget 1" module scripts
  ...
  <div class="col-xl-4 col-lg-6">
    ...
    <div class="card">
      <div class="card-body">
        <ul class="list-unstyled">
  <li class="kit__l15__item">
    <a href="#" class="kit__l15__itemLink">
      <div class="kit__l15__itemCover mr-3">
        <img src="../../components/kit/core/img/content/hands.png" alt="Hands" />
      </div>
      <div>
  ...
  <div class="table-responsive">
    <table class="table table-borderless text-gray-6 mb-0">
      <tbody>
        ...
        <tr>
          <td class="text-nowrap">
            <div class="kit__l12__donut kit__l12__donut--orange mr-3"></div>
            New York
          </td>
          <td class="text-right"><strong>+8,125,642.00$</strong></td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="air__footer__inner">
    <div class="row">
      <div class="col-md-8">
        ...
        <p>
          &copy; 2019 Mediatec Software
        </p>
      </div>
      <div class="col-md-4">
        <div class="air__footer__logo">
          <div class="air__footer__logo__letter">A</div>
          <div class="air__footer__logo__name">AIR UI</div>
          <div class="air__footer__logo__descr">Admin Template</div>
        </div>
      </div>
    </div>
  </div>
...
<!-- Mirrored from html.airui.cloud/versions/left-default-gray/dashboards-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 22:32:42 GMT -->
</html>