...
<div class="tab-content" id="v-pills-tabContent">
    <!-------USER lIST---->
    <div class="tab-pane fade <?php if(!isset($print_report))echo 'show active'; ?>" id="list" role="tabpanel"
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $u['drop_off'] ?></td>
                                        <td><?= $u['number_room'] ?></td>
                                        <td><?= get_column_name_by_id('setting_vendor', $u['vendor_id'], 'company_name') ?>
                                        </td>
                                        <td class="price"> Gh¢.<?= $u['total_price']. '.00' ?></td>
                                        <td><?= get_column_name_by_id('category_service_tbl', $u['category_id'], 'category_name') ?>
                                        </td>
                                        <td><?= get_column_name_by_id('sub_category_service_tbl', $u['cat_service_id'], 'sub_cat_name') ?>
                                        </td>
                                        <td><?= get_column_name_by_id('service_tbl', $u['service_id'], 'service_name') ?>
                                        </td>
                                        <td>
                                            <a href="/booking/approve/<?= $u['id'] ?>"
                                                class="theme-btn theme-btn-small"><i class="la la-times mr-1"> <span
                                                        class="font-size-12 badge badge-primary">Approved</span></a>
                                            <a href="/booking/cancel/<?= $u['id'] ?>" id="cancel-booked"
                                                class="btn btn-sm btn-light"><small><i class="fe fe-trash mr-2">
                                                        <!-- -->
                                                    </i></small>Canceled</a>
                                        </td>
                                    </tr>
