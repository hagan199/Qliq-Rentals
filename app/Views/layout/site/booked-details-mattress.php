                ...
                <div class="col-lg-4">
                    <div class="sidebar single-content-sidebar mb-0">
                        <div class="sidebar-widget single-content-widget">
                            ...
                            <input class="form-control" type="text" id="event_location" name="event_location" placeholder="Enter Location"  required >
                            ...
                            <input class="form-control"  hidden type="text" id="category_id" value="<?php echo $category_id; ?> " name="category_id"> 
                                    ...
                                    <div class="col">
                                            <div class="qty-box d-flex align-items-center justify-content-between">
                                                    <label for="numer_room">Number Mattress     <span class="text-warning">*</span></label>
