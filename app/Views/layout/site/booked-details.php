    ...
    <section class="room-detail-bread">
        ...
        <div class="full-width-slider carousel-action">
            <div class="full-width-slide-item">
                <img src="/uploads/images/<?= $row['name'] ?>" width="700" height="500" alt="hotel-img">
            </div><!-- end full-width-slide-item -->

            <div class="full-width-slide-item">
                <img src="/uploads/images/<?= $row['name3'] ?>" width="700" height="500" alt="hotel-img">
            </div><!-- end full-width-slide-item -->
            ...
            <div class="container">
                <div class="row">
                        ...
                        ?>
                            <div id="description" class="page-scroll">
                                <div class="single-content-item pb-4">
                                    <h3 class="title font-size-26">
                                        <?= get_column_name_by_id('sub_category_service_tbl', $row['sub_category_id'], 'sub_cat_name') ?>
                                    </h3>
                                    <br>
                            ...
                            <div id="services" class="page-scroll">
                                <div class="single-content-item padding-top-40px padding-bottom-40px">
                                    <h3 class="title font-size-20">Other Services</h3>
                                    <div class="row pt-4">
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Social Gathering
                                                    </h3>
                                                </div>
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Music &
                                                        Entertainment</h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Pickup & Delievery
                                                    </h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Building Tools &
                                                        Equipment</h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                    ...
                                    <div class="row pt-4">
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">House Cleaning
                                                    </h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Stager Lighting
                                                    </h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Video Coverage
                                                    </h3>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                        ...
                        <div class="sidebar single-content-sidebar mb-0">
                            <div class="sidebar-widget single-content-widget">
                                ...
                                <div class="sidebar-widget-item">
                                    ...
                                    <div class="col">
                                        <label class="label-text" for="event_location">Event Locations <span
                                                class="text-warning">*</span></label>
                                        <div class="form-group">

                                            <input class="form-control" type="text" id="event_location"
                                                name="event_location" placeholder="Enter Location">
                                            <input id="box2" type="text" id="price" name="price" hidden
                                                value="<?php echo $price; ?> " oninput="calculate()" />
                                            <input class="form-control" hidden type="text" id="cat_service_id"
                                                value="<?php echo $cat_id; ?> " name="cat_service_id">
                                            <input class="form-control" hidden type="text" id="vendor_id"
                                                value="<?php echo $vendor_id; ?> " name="vendor_id">
                                            <input class="form-control" hidden type="text" id="service_id"
                                                value="<?php echo $service_id; ?> " name="service_id">
                                            <input class="form-control" hidden type="text" id="category_id"
                                                value="<?php echo $category_id; ?> " name="category_id">
                                        </div>
                                    </div>

                                    <div class="col">
                                        <label class="label-text">Pickup Date <span
                                                class="text-warning">*</span></label>
                                        <div class="form-group">
                                            <input class="date-range form-control" type="text" id="pickup_date"
                                                name="daterange-single" required readonly>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <label name="drop_off" class="label-text">Drop off date<span
                                                class="text-warning">*</span></label>
                                        <div class="form-group">
                                            <input class="date-range form-control" type="text" id="drop_off"
                                                name="daterange-single" required readonly>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <label for="event_type" class="label-text">Event Type <span
                                                class="text-warning">*</span></label>
                                        <div class="form-group">
                                    ...
                                    <div class="col">
                                        <div class="qty-box d-flex align-items-center justify-content-between">
                                            ...
                                            <input id="number_room" type="number" name="number_room"
                                                oninput="calculate()" value="1" requried />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button data-toggle="modal" data-target="#contactdetail"
                                    class="theme-btn text-center w-100 mb-2">Book Now</button>
                            </div>
                        </div>
                        </form>
                    </div>
                    ...
                    <div class="sidebar-widget single-content-widget">
                        ...
                        <p class="font-size-14 line-height-24">Do not hesitate to give us a call. We are an expert team
                            and we are happy to talk to you.</p>
                        <div class="sidebar-list pt-3">
                            <ul class="list-items">
                                <li><i class="la la-phone icon-element mr-2"></i><a href="#">+ (233) 241 977 5256
                                    </a></li>
                                <li><i class="la la-envelope icon-element mr-2"></i><a
                                        href="mailto:info@trizen.com">info@qliqintegrations.com</a></li>
                            </ul>
                        </div><!-- end sidebar-list -->
                    </div><!-- end sidebar-widget -->
                </div><!-- end sidebar -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="air__auth__containerInner mt-4">
                            ...
                            <div style="background: #A8FF33" ; style="padding: 20px" ; style="color: white" ;
                                id="promptme"></div>
                            <div class="row">
