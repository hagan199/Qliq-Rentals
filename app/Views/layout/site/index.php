        ...
        <div class="air__menuLeft__logo__descr">GNAT Booking</div>
			...
			<div id="bottom-nav">
				...
				<nav id="nav">
					...
					<!-- button nav -->
					<ul class="cta-nav">
						<li><a href="index.html#reservation" class="main-button">Login</a></li>
					</ul>
					<!-- button nav -->

					<!-- contact nav -->
					<ul class="contact-nav nav navbar-nav">
						<li><a href="tel:0455481497"><i class="fa fa-phone"></i> 024-548-0004</a></li>
					</ul>
					<!-- contact nav -->
			...
			<div class="home-wrapper">
				...
				<div class="col-md-10 col-md-offset-1 text-center">
					<div class="home-content">
						<h1 class="white-text">Welcome To GNAT Hall</h1>
						<h4 class="white-text lead">The Beauty Halls are world-class, immersive spaces on the Ground Floor where you’ll find prestigious brands and cult products. Head down the spectacular golden staircase to Beauty Events & Services, home to exclusive events, must-book treatments and the Beauty Concierge.</h4>
						<a href="index.html#menu"><button class="main-button">Discover Service</button></a>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="section-header text-center">
						...
						<h2 class="title">The GNAT Hall</h2>
					</div>
					<!-- /section header -->

					<!-- about content -->
					<div class="col-md-5">
						<h4 class="lead">Welcome to GNAT HALL. With more than TWO decades of experience, GNAT owned and operated, Hall’s is the premiere event rental service in takoradi able to serve parties and events as intimate as 10 or as large as 10,000. </h4>
					</div>
					<!-- /about content -->
					<!-- about content -->
					<div class="col-md-7">
						<p>Always ready to serve you, Hall’s representatives can assist in design, planning, logistics and financial follow-through.</p>
					</div>
					<!-- /about content -->
