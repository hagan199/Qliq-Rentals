                    ...
                    <div class="header-top-content">
                        <div class="header-left">
                            <ul class="list-items">
                                ...
                                <li><a href="#"><i class="la la-envelope mr-1"></i>info@qliqintegrations.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-top-content">
                        <div class="header-right d-flex align-items-center justify-content-end">
                            ...
                            <!---  <a href="#" class="theme-btn theme-btn-small theme-btn-transparent mr-1" data-toggle="modal" data-target="#signupPopupForm">Sign Up</a> --->
                                 <a href="/login" class="theme-btn theme-btn-small" data-toggle="modal" data-target="#loginPopupForm">Login</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            <li><a href="tour-fullwidth.html">Our Team</a></li>                                       
                                        </ul>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#">Contact Us <i class="la la-angle-down"></i></a>
                                        <ul class="dropdown-menu-item">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center active" id="flight-tab" data-toggle="tab" href="#flight" role="tab" aria-controls="flight" aria-selected="true">
                                    <i class="la la-plane mr-1"></i>Canopies
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center" id="hotel-tab" data-toggle="tab" href="#hotel" role="tab" aria-controls="hotel" aria-selected="false">
                                    <i class="la la-hotel mr-1"></i>Chairs
                                </a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <div class="contact-form-action">
                                        <form action="#" class="row align-items-center">
                                            <div class="col-lg-6 pr-0">
                                                <div class="input-box">
                                                    <label class="label-text">Flying froms</label>
            ...
            <div class="col-lg-7">
                <div class="copy-right padding-top-30px">
                    <p class="copy__desc">
                        ...
                        <span class="la la-heart"></span> by <a href="https://themeforest.net/user/techydevs/portfolio">Qliq Integrations</a>
                    </p>
                </div><!-- end copy-right -->
            </div><!-- end col-lg-7 -->
            <div class="col-lg-5">
