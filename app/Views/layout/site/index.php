                ...
                <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                    <div class="section-tab section-tab-2 pb-3">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="flight-hotel-tab" data-toggle="tab" href="#flight-hotel"
                                    role="tab" aria-controls="flight-hotel" aria-selected="true">
                                    Canopies
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="flight-hotel-car-tab" data-toggle="tab" href="#flight-hotel-car"
                                    role="tab" aria-controls="flight-hotel-car" aria-selected="false">
                                    Chairs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="flight-car-tab" data-toggle="tab" href="#flight-car" role="tab"
                                    aria-controls="flight-car" aria-selected="false">
                                    Tables
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="hotel-car-tab" data-toggle="tab" href="#hotel-car" role="tab"
                                    aria-controls="hotel-car" aria-selected="true">
                                    Mattress
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <div class="card-item car-card mb-0">
                                        <div class="card-img">
                                            <a href="/book/<?= $u['id'] ?>" class="d-block">
                                                <img src="/uploads/images/<?= $u['name'] ?>" width="300" height="200"
                                                    alt="car-img">
                                            </a>
                                        ...
                                        <div class="card-body">
                                            <p class="card-meta"><a
                                                    href="car-single.html"><?= get_column_name_by_id('sub_category_service_tbl', $u['sub_category_id'], 'sub_cat_name') ?></a>
                                            </p>
                                            <h3 class="card-title"><a
                                                    href="car-single.html"><?= get_column_name_by_id('category_service_tbl', $u['category_id'], 'category_name') ?>
                                                    | Gh¢.<?= $u['price'] ?></a></h3>
...
<section class="info-area info-bg padding-top-90px padding-bottom-70px">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 responsive-column">
                <a href="/method-payment" class="icon-box icon-layout-2 d-flex">
            ...
            <div class="col-lg-4 responsive-column">
                <a href="policy" class="icon-box icon-layout-2 d-flex">
